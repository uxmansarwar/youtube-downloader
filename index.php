...
require_once __DIR__ . DIRECTORY_SEPARATOR . 'youtube.class.php';
require_once __DIR__ . DIRECTORY_SEPARATOR . 'vendor/autoload.php';
$handler = new YouTubeDownloader(); 
 
// Youtube video url 
$youtubeURL = 'https://www.youtube.com/watch?v=1TNAq6jdf4k'; 
// $youtubeURL = 'https://www.youtube.com/watch?v=AIzSnHzjGnc'; 
$youtubeURL = 'https://www.youtube.com/watch?v=asYxxtiWUyw'; 
